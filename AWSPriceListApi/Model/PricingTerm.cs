...
namespace BAMCIS.AWSPriceListApi.Model
{
    ...
    public class PricingTerm
    {
        ...
        {
            if (String.IsNullOrEmpty(offerTermCode))
            {
                throw new ArgumentNullException(nameof(offerTermCode));
            }
            ...
            this.TermAttributes = termAttributes ?? throw new ArgumentNullException(nameof(termAttributes));
        }
